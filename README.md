...
- 체리케이크 -> 2월달
2. 개인프로젝트 준비 -> 기본적인 준비 끝내기
3. 지역 개발 커뮤니티 가입 -> 게임관련 커뮤니티 가입(인디터, 그리고 지역커뮤)
4. 블로그 글 5개이상 포스팅(원래는 10개)
- 프로그래머의 길, 멘토에게 묻다.(독후감 포스팅)
- 멘토링정리(객체지향을 시작하는 방법, 내가 앞으로 걸어갈 길 등), 홈커밍데이, 오프라인만남
- 버닝비버(다녀온 후기 앞으로의 각오)
- 비버잼(UITOOLKIT -> 개인프로젝트 공지)
5. 방학 2달 세미프로젝트 들어가기 
